...
// Combine own props with the props of the component passed via 'as', omitting duplicates
...
export function Button<C extends React.ElementType = "button">({
  ...
  // Set the component to be rendered, defaulting to 'button'
...
// Define props for MovingBorder, extending standard SVG component props
