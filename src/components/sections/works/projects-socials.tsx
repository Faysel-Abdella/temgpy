...
export default function ProjectsSocials() {
  ...
  return (
    <div className="flex items-center justify-center w-full md:max-w-[260px] gap-4">
        ...
        {socialLinks.map((link, index) => {
          ...
          return (
            <motion.a
              ...
              className="flex h-13 items-center justify-center border-2 border-white/20  rounded-full bg-white/20 shadow-sm px-1  outline-neutral-300/15"
              ...
              <div
                ...
                <span
                  ...
                  className="whitespace-nowrap pr-4 ml-1 text-sm md:text-md font-inter font-medium text-white">
                  {link.name}
                </span>
              </div>
            </motion.a>
