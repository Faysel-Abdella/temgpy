...
export default function ReadingBlog() {
  ...
  const sections = [
    ...
    {
      id: "key-benefits",
      title: "Key Benefits of a Career in Software Development",
    },
    {
      id: "key-skills",
      title: "Key Skills Required for Software Developers",
    },
    {
      id: "how-to-start",
      title: "How to Start Your Journey in Software Development",
    },
  ];
