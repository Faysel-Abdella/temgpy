...
export async function generateMetadata(): Promise<Metadata> {
  const slug = "the-role-of-it-consultation-in-business-growth"; // Static slug for this route
  ...
  return {
    ...
    openGraph: {
      ...
      url: "https://growztech.com/blogs/the-role-of-it-consultation-in-business-growth",
      type: "article",
      images: [
        {
...
export default async function Page() {
  const slug = "the-role-of-it-consultation-in-business-growth"; // Static slug
