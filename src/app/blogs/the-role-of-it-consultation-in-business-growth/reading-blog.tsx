...
import WhatIsItSection from "./what-is-section copy";
import HowItSection from "./how-it-section";
import KeyBenefitsSection from "./key-benefits-section";
import ChoosingItSection from "./choosing-it-section";
...
export default function ReadingBlog() {
  ...
  const sections = [
    ...
    {
      id: "what-is-it",
      title: "What is IT Consultation?",
    },
    {
      id: "how-it",
      title: "How IT Consultation Drives Business Growth",
    },
    {
      id: "key-benefits",
      title: "Key Benefits of IT Consultation for Businesses",
    },
    {
      id: "choose",
      title: "Choosing the Right IT Consultant",
    },
  ];
  ...
  return (
    <div className="relative mx-auto w-full px-4 max-w-[1080px] flex gap-14 ">
      {/* Main Content Area */}
      <div className="flex flex-col  max-w-[757px] mx-auto gap-6 md:gap-8">
        <IntroductionSection />
        <WhatIsItSection />
        <HowItSection />
        <KeyBenefitsSection />
