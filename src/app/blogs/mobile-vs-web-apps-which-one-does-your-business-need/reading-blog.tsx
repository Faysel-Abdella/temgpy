...
import UnderstandingMobileAppsSection from "./understanding-mobile-apps-section";
import WebApplicationsSection from "./web-applications-section";
import HowToChooseSection from "./how-to-choose-section";
import KeyDifferencesSection from "./key-differences-section";
...
export default function ReadingBlog() {
  ...
  const sections = [
    ...
    { id: "understanding-mobile-apps", title: "Understanding Mobile Apps" },
    { id: "web-applications", title: "Web Applications" },
    {
      id: "key-differences",
      title: "Key Differences Between Mobile & Web Apps",
    },
    {
      id: "how-to-choose",
      title: "How to Choose the Right One for Your Business",
    },
  ];
  ...
  return (
    <div className="relative mx-auto w-full px-4 max-w-[1080px] flex gap-14 ">
      ...
      <div className="flex flex-col  max-w-[777px] mx-auto gap-6 md:gap-8">
        ...
        <UnderstandingMobileAppsSection />
