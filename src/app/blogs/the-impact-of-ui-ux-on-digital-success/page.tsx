...
export async function generateMetadata(): Promise<Metadata> {
  const slug = "the-impact-of-ui-ux-on-digital-success"; // Static slug for this route
  ...
  return {
    ...
    openGraph: {
      ...
      url: "https://growztech.com/blogs/the-impact-of-ui-ux-on-digital-success",
      type: "article",
      images: [
        {
...
export default async function Page() {
  const slug = "the-impact-of-ui-ux-on-digital-success"; // Static slug
