...
import WhatIsUiUxSection from "./what-is-ui-ux-section";
import WhyUiUxSection from "./why-ui-ux-section";
import KeyElementsSection from "./key-elements-section";
...
export default function ReadingBlog() {
  ...
  const sections = [
    ...
    {
      id: "why-ui-ux",
      title: "Why UI/UX is Crucial for Digital Success",
    },
    {
      id: "key-elements",
      title: "Key Elements of Effective UI/UX Design",
    },
    {
      id: "how-to-prioritize",
      title: "How to Prioritize UI/UX for Your Business",
    },
  ];
